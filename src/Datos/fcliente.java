...
public class fcliente {
    ...
    public DefaultTableModel mostrar(String buscar){
       ...
       sSQL="select * from Cliente where RazonSocial like '%"+ buscar + "%' order by idCliente";
   ...
   public boolean editar (vcliente dts){
       sSQL="update Cliente set TipoDocumento=?,Documento=?,RazonSocial=?,Direccio=?,E_Mail=?,Telefono=?"+
               " where idCliente=?";
